...
import {close, logo_editor, menu} from '../assets';
...
const NavBar = () => {
  ...
  return (
   <>
    ...
    navbar'>
      <img src={logo_editor} alt="Bank_BR" 
      className='w-[156px] h-[141px]'/>
      ...
      <div className='sm:hidden flex flex-1 justify-end items-center'>
        ...
        top-20 right-0 mx-4 my-8 min-w-[140px] rounded-xl sidebar`}>
